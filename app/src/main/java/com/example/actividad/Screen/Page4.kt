    ...
    LazyColumn(
        ...
        item {
            LazyRow(
                ...
                items(listOf(
                    R.drawable.ic_launcher_img4, R.drawable.ic_launcher_img6, R.drawable.ic_launcher_img5,R.drawable.ic_launcher_img7, R.drawable.ic_launcher_img8, R.drawable.ic_launcher_img9, R.drawable.ic_launcher_img10
        ...
        item {
            LazyRow(
                ...
                items(listOf( R.drawable.ic_launcher_img4, R.drawable.ic_launcher_img6, R.drawable.ic_launcher_img5,R.drawable.ic_launcher_img7, R.drawable.ic_launcher_img8, R.drawable.ic_launcher_img9, R.drawable.ic_launcher_img10)) { imgRes ->
        ...
        items(listOf(
            ...
            "En Granjas Presiga, nos enorgullece ofrecerte una selección de productos 100% colombianos, directamente desde nuestras tierras a tu mesa. Huevos frescos, plátanos maduros y más, todos cultivados con amor y cuidado, sin añadidos artificiales. ¡Con nosotros, disfruta lo mejor de la naturaleza colombiana!",
            ...
            "Siente el vínculo con la naturaleza en cada bocado. En Granjas Presiga, cultivamos nuestros productos con métodos tradicionales y respetuosos con el medio ambiente. Con cada compra, apoyas a agricultores locales y contribuyes a la preservación de nuestra herencia colombiana.",
